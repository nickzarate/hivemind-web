...
export const ADD_WINNINGS = 'ADD_WINNINGS'
export const CLEAR_WINNINGS = 'CLEAR_WINNINGS'
...
export const SET_CORRECT_ANSWER_INDICES = 'SET_CORRECT_ANSWER_INDICES'
...
export const SET_TOOLTIP_TARGET = 'SET_TOOLTIP_TARGET'
export const SET_TYPES = 'SET_TYPES'
export const SET_UNLOCKED = 'SET_UNLOCKED'
export const SET_WORTH = 'SET_WORTH'
