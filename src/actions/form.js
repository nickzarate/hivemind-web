...
export const initializeErrorMessage = createAction(INITIALIZE_ERROR_MESSAGE, errorMessage => errorMessage)
export const initializeValues = createAction(INITIALIZE_VALUES, values => values)
export const setErrorMessage = createAction(SET_ERROR_MESSAGE, (errorMessage, formIndex) => { return { errorMessage, formIndex } })
export const setValue = createAction(SET_VALUE, (value, formIndex, index) => { return { value, formIndex, index } })
export const setValues = createAction(SET_VALUES, values => values)
